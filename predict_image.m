...
%This example code classifies pixels in one labeled image data set,
%"Acav_test_M2.tif. To classify other images, edit lines 24 and 25.
...
imgPath   = fullfile(repoRoot, "data", "test",   "Acav_test_M2_data.tif");
maskPath  = fullfile(repoRoot, "data", "test_masks", "Acav_test_M2_mask.tif");
