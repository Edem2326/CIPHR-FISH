...
taxa = [
    struct("name","Acav","label","AaquaT","img","Acav_train_M2_new.tif","mask","Acav_train_M2_new_BW.tif")
    struct("name","AverBC1","label","Aver1T","img","AverBC1_train_M2_new.tif","mask","AverBC1_train_M2_new_BW.tif")
    struct("name","AverBC9","label","Aver9T","img","AverBC9_train_M2_new.tif","mask","AverBC9_train_M2_new_BW.tif")
    struct("name","Cmas","label","cmasT","img","Cmas_train_M2_new.tif","mask","Cmas_train_M2_new_BW.tif")
    struct("name","Psed","label","psedT","img","Psed_train_M2_new.tif","mask","Psed_train_M2_new_BW.tif")
    struct("name","Pmos","label","pmosT","img","Pmos_train_M2_new.tif","mask","Pmos_train_M2_new_BW.tif")
    struct("name","Pmys","label","PmysT","img","Pmys_train_M2_new.tif","mask","Pmys_train_M2_new_BW.tif")
    struct("name","Pnit","label","pnitT","img","Pnit_train_M2_new.tif","mask","Pnit_train_M2_new_BW.tif")
    struct("name","Ppel","label","ppelT","img","Ppel_train_M2_new.tif","mask","Ppel_train_M2_new_BW.tif")
    struct("name","Smal","label","smalT","img","Smal_train_M2_new.tif","mask","Smal_train_M2_new_BW.tif")
];
...
% Make id categorical (cleaner for classification)
